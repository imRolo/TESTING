...
local Window = Library.CreateLib("Olor", "DarkTheme")


local Tab = Window:NewTab("Force XD")
local Section = Tab:NewSection("Force")

Section:NewButton("Fly", "C to fly - and = for speed up slow down", function()
...
Section:NewButton("AutoParry", "Use brain", function()
    -- // Dependencies
...
Section:NewButton("UnamedESP", "ESP", function()
...
Section:NewButton("Attach to back", "Press x on a player", function()
    pcall(function()
...
Section:NewButton("God 1", "PRESS FIRST OR BANNED", function()
    getgenv().GodMode = false -- if u gonna change this reset after u change
getgenv().AntiPrettyMuchEverything = false -- stun, ragdoll, m1 & m2 cooldown, etc
...
Section:NewButton("God 2 Press after 1", "Now reset for god", function()
